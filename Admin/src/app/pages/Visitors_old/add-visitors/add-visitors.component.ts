...
export class AddVisitorsComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private clinicService: ClinicService, private patientService: PatientService, private visitService: VisitService,
    private router:Router, private route: ActivatedRoute,) {
    this.visitorsForm = this.fb.group({
      visit_clinicid: ["",[Validators.required]],
      visit_no: ["",[Validators.required]],
