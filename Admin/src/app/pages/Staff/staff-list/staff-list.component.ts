...
export class StaffListComponent {
  ...
  ngOnInit() {
    ...
    if (staffrole == "superadmin") {
      this.fetchstaffs("superadmin", userid, clinicid);
    } else if (stafftype == "cadmin") {
      this.fetchstaffs("cadmin", userid, clinicid);
    } else if (stafftype == "cstaff") {
      this.fetchstaffs("cstaff", userid, clinicid);
    } else {
  ...
  fetchstaffs(type: string, userid: string, clinicid: string): void {
    this.StaffService.getStaffs(type, userid, clinicid).subscribe((response: any) => {
